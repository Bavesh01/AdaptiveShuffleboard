...
int pinion_RPWM = 32;  //connect Arduino pin 32 to IBT-2 pin RPWM FOR PINION BLUE
int pinion_LPWM = 33;  //connect Arduino pin 33 to IBT-2 pin LPWM FOR PINION GREEN
...
void setup() {
  ...
  myservo.attach(5, 500, 2500);  // attaches the servo on pin 5 to Arduino
